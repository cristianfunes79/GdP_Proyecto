...
1      & Se completa hasta el punto 5 inclusive                 & dd/mm/aaaa \\ \hline
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en la implementación de un prototipo de un sensor de estacionamiento con conectividad LoRaWAN, y tendrá un presupuesto preliminar estimado de 600 hs de trabajo y \textcolor{red}{\$XXX}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
El proyecto que aquí se describe, consiste en la implementación de un sensor de estacionamiento del tipo "tacha", con conectividad LoRaWAN.
Dicho sensor estará alimentado con baterías, y utilizar como forma de detección un magnetómetro y un sensor del tipo "tiempo de vuelo" (o ToF por sus siglas en ingles).
Cuando un vehículo se posicione sobre el dispositivo, el sensor lo detectara y enviara un mensaje a un servidor LoRaWAN indicando dicho evento. Esto permitirá realizar una medición en tiempo real de cuanto tiempo estuvo el vehículo estacionado.
Algo fundamental en este proyecto es poder lograr una autonomia lo mas alta posible. Esto se debe a que si no se logra la autonomia adecuada, el proyecto no sera escalable a un numero grande de sensores de estacionamiento. 
Tambien debe ser posible conectar un gran numero de nodos a la red. Por ello se decidio utilizar tecnologia LoRaWAN.
La tecnologia LoRaWAN permite conectar un numero muy grande de dispositivos, con una topologia estrella que es facilmente escalable. 
Ademas el tipo de modulacion LoRA permite alcanzar grandes distancias de conexion con bajo consumo de energia.

En la siguiente figura se puede observar un diagrama en bloques del sistema:
...
\begin{itemize}
	\item Diseno, implementacion y montaje de una placa funcional para el sensor de estacionamiento.
	\item Desarrollo del firmware para el microcontrolador del sensor de estacionamiento.
	\item Desarrollo de entorno de testing.
	\item Configuracion y puesta en marcha de Gateway LoRaWAN.
	\item Configuracion y puesta en marcha de servidor LoRaWAN.
\end{itemize}

El presente proyecto no incluye:
\begin{itemize}
	\item Despliegue de red de mas de un sensor.
	\item Diseno de gabinete.
	\item Instalacion de sensor en via publica.
	\item Desarrollo de aplicacion de parquimetro.
\end{itemize}
...
\begin{itemize}
	\item Se conseguiran todos los componentes necesarios para la implementacion del dispositivo.
	\item Se podra hacer uso de un Gateway LoRa.
	\item Se podra utilizar la banda ISM 915MHz.	
\end{itemize}
